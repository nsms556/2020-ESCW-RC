...
class laneDetectCV2(object):

    def __init__(self):
        logging.info('Creating a laneDetectCV2')
...
def test_video(videoCapture):
    lane_follower = laneDetectCV2()
    cap = videoCapture
    ...
    try:
        ...
        while cap.isOpened():
            _, frame = cap.read()
            print('frame %s' % i )
            steer_angle, combo_image= lane_follower.follow_lane(frame)
